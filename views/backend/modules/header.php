        ...
        <nav class="navbar-color">
            <div class="nav-wrapper">
                    ...
                    <li>
                        <h1 class="logo-wrapper">
                            <a href="main.php" class="brand-logo darken-1">
                                <img src="modules/logo/materialize-logo.png" alt="materialize logo">
                ...
                <ul id="profile-dropdown" class="dropdown-content">
                    <li>
                        <a href="main.php?c=9" class="grey-text text-darken-1">
                    ...
                    <li>
                        <a href="../backend/dangnhap/dangxuat.php" class="grey-text text-darken-1">
