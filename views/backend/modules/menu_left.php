                    ...
                    <div class="row">
                        <div class="col col s4 m4 l4">
                            <img src="modules/logo/<?php echo $_SESSION["SHinh"]?>" alt="Quản trị viên"
								 class="circle responsive-img valign profile-image cyan" style="height: 50px;width: 50px">
                        </div>
                        <div class="col col s8 m8 l8">
                            <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="main.php?c=9"
                    ...
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li class="bold">
                            ...
                            <div class="collapsible-body">
                                <ul class="collapsible" data-collapsible="accordion">
                                    <li>
                                        <a href="main.php?c=11">
                                            <i class="material-icons">keyboard_arrow_right</i>
                                            <span>Danh sách đơn đặt hàng</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="main.php?c=12">
                                            <i class="material-icons">keyboard_arrow_right</i>
